//wes local
//tealium universal tag - utag.93 ut4.0.201701112113, Copyright 2017 Tealium.com Inc. All Rights Reserved.
try {
    (function(id, loader) {
        var u = {};
            ...
            if (u.ev[a] || typeof u.ev.all !== "undefined") {
                ...
                if (typeof u.data.OID !== "undefined" && u.data.OID) {
                    ...
                    if (u.data.stype == "advanced") {
                        u.data.ITEM = u.data.ITEM || _cprod;
                        u.data.AMT = u.data.AMT || _cprice;
                        u.data.QTY = u.data.QTY || _cquan;
                        u.data.DCNT = u.data.DCNT || _cpdisc;
                        for (d = 0; d < u.data.ITEM.length; d++) {
                            c.push('ITEM' + (d + 1) + '=' + u.data.ITEM[d]);
                            c.push('AMT' + (d + 1) + '=' + (u.data.AMT[d] || '0'));
                            c.push('QTY' + (d + 1) + '=' + (u.data.QTY[d] || '1'));
                            if (u.data.DCNT[d]) {
                                c.push('DCNT' + (d + 1) + '=' + u.data.DCNT[d]);
                            }
                        }
                    } else {
