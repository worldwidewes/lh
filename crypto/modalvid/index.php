...
<div class="container">
  <a href="#" id='vid1' class="modalClick"> <img class="col-lg-4" src="surf_thumb.png">
 </a>
...
<div class="embed-responsive embed-responsive-16by9 col-lg-12" id="vidctn">
            <iframe id='yt-player' allowfullscreen class="embed-responsive-item" src="https://www.youtube.com/embed/oV-9HbxXuCg"></iframe>
        </div>
   </div>
</div>
